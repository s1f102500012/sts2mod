...
ROOT="/Users/iniad/sts2-mods/WoLuGuo"
FILE_STEM="WoLuGuo"
...
if (( ${#EXTRA_DLLS[@]} > 0 )); then
  ...
  print -u2 "WoLuGuo must ship as a standard single-DLL mod; mark references Private=false or remove package dependencies."
  exit 1
fi
